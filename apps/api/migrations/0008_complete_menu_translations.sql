...
CREATE TABLE `__new_translations` (
	...
	CONSTRAINT "translations_entity_type" CHECK("__new_translations"."entity_type" IN ('dish', 'category', 'variant_group', 'variant_option', 'ingredient', 'promotion', 'branch', 'reward'))
);
--> statement-breakpoint
INSERT INTO `__new_translations`("id", "restaurant_id", "entity_type", "entity_id", "language_code", "field", "value", "source_text", "is_manual", "created_at", "updated_at") SELECT "id", "restaurant_id", "entity_type", "entity_id", "language_code", "field", "value", "source_text", "is_manual", "created_at", "updated_at" FROM `translations`;--> statement-breakpoint
