...
export interface QmThemeTokens {
  ...
  "--qm-modal-chrome-height": string;
  "--qm-modal-title-size": string;
  "--qm-modal-title-leading": string;
  "--qm-modal-title-tracking": string;
  "--qm-modal-price-size": string;
  "--qm-modal-media-inset": string;
  "--qm-modal-photo-border": string;
  "--qm-modal-photo-cap": string;
  ...
  "--qm-modal-handle-height": string;
  "--qm-modal-handle-bg": string;
  "--qm-modal-handle-border": string;
  "--qm-modal-handle-radius": string;
  "--qm-modal-close-bg": string;
  "--qm-modal-close-border": string;
  "--qm-modal-close-color": string;
  "--qm-modal-close-radius": string;
