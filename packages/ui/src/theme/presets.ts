...
export type QmTemplateLayoutDefaults = Pick<
  ...
  | "--qm-modal-chrome-height"
  | "--qm-modal-close-bg"
  | "--qm-modal-close-border"
  | "--qm-modal-close-color"
  | "--qm-modal-close-radius"
  | "--qm-modal-handle-bg"
  | "--qm-modal-handle-border"
  | "--qm-modal-handle-height"
  | "--qm-modal-handle-overhang"
  | "--qm-modal-handle-radius"
  | "--qm-modal-handle-width"
  | "--qm-modal-lead-bg"
  | "--qm-modal-lead-border"
  | "--qm-modal-lead-rail"
  | "--qm-modal-media-inset"
  | "--qm-modal-pad-x"
  | "--qm-modal-photo-border"
  | "--qm-modal-photo-cap"
...
export const TEMPLATES: Record<QmTemplateName, QmTemplatePreset> = {
  fine: {
    ...
    layout: {
      ...
      "--qm-sheet-min": "0px",
      "--qm-modal-pad-x": "24px",
      "--qm-modal-chrome-height": "56px",
      "--qm-modal-title-size": "2.25rem",
      "--qm-modal-title-leading": "0.98",
      "--qm-modal-title-tracking": "-0.025em",
      "--qm-modal-price-size": "1.375rem",
      "--qm-modal-media-inset": "24px",
      "--qm-modal-photo-ratio": "3 / 2",
      "--qm-modal-photo-border": "none",
      "--qm-modal-photo-cap": "none",
      ...
      "--qm-modal-handle-height": "32px",
      "--qm-modal-handle-bg": "transparent",
      "--qm-modal-handle-border": "none",
      "--qm-modal-handle-radius": "0px",
      "--qm-modal-close-bg": "transparent",
      "--qm-modal-close-border": "1px solid var(--qm-ink)",
      "--qm-modal-close-color": "var(--qm-ink)",
      "--qm-modal-close-radius": "0px",
  ...
  her: {
    ...
    layout: {
      ...
      "--qm-sheet-min": "0px",
      "--qm-modal-pad-x": "20px",
      "--qm-modal-chrome-height": "54px",
      "--qm-modal-title-size": "1.875rem",
      "--qm-modal-title-leading": "1.02",
      "--qm-modal-title-tracking": "-0.015em",
      "--qm-modal-price-size": "1.3rem",
      "--qm-modal-media-inset": "20px",
      "--qm-modal-photo-ratio": "3 / 2",
      "--qm-modal-photo-border": "1px solid var(--qm-hairline)",
      "--qm-modal-photo-cap": "5px solid var(--qm-secondary)",
      "--qm-modal-lead-bg": "transparent",
      ...
      "--qm-modal-handle-border": "none",
      "--qm-modal-handle-radius": "0px",
      "--qm-modal-close-bg": "var(--qm-card)",
      "--qm-modal-close-border": "1px solid var(--qm-ink)",
      "--qm-modal-close-color": "var(--qm-ink)",
      "--qm-modal-close-radius": "3px",
  ...
  fast: {
    ...
    layout: {
      ...
      "--qm-modal-pad-x": "20px",
      "--qm-modal-chrome-height": "54px",
      "--qm-modal-title-size": "2.375rem",
      "--qm-modal-title-leading": "0.92",
      "--qm-modal-title-tracking": "0em",
      "--qm-modal-price-size": "1.625rem",
      "--qm-modal-media-inset": "0px",
      "--qm-modal-photo-ratio": "16 / 10",
      "--qm-modal-photo-border": "none",
      "--qm-modal-photo-cap": "6px solid var(--qm-secondary)",
      "--qm-modal-lead-bg": "transparent",
      "--qm-modal-lead-border": "1px solid var(--qm-hairline)",
      ...
      "--qm-modal-handle-border": "none",
      "--qm-modal-handle-radius": "0px",
      "--qm-modal-close-bg": "var(--qm-primary)",
      "--qm-modal-close-border": "none",
      "--qm-modal-close-color": "var(--qm-on-primary)",
      "--qm-modal-close-radius": "12px",
  ...
  cafe: {
    ...
    layout: {
      ...
      "--qm-modal-pad-x": "20px",
      "--qm-modal-chrome-height": "54px",
      "--qm-modal-title-size": "2rem",
      "--qm-modal-title-leading": "1.02",
      "--qm-modal-title-tracking": "-0.02em",
      "--qm-modal-price-size": "1.375rem",
      "--qm-modal-media-inset": "12px",
      ...
      "--qm-modal-close-color": "var(--qm-emph-ink)",
      "--qm-modal-close-radius": "50%",
      "--qm-category-radius": "999px",
      "--qm-category-bg": "var(--qm-card)",
      "--qm-category-border": "1px solid var(--qm-hairline)",
      "--qm-category-gap": "8px",
  ...
  tapas: {
    ...
    layout: {
      ...
      "--qm-modal-pad-x": "20px",
      "--qm-modal-chrome-height": "54px",
      "--qm-modal-title-size": "2.125rem",
      "--qm-modal-title-leading": "0.95",
      "--qm-modal-title-tracking": "0.025em",
      "--qm-modal-price-size": "1.5rem",
      "--qm-modal-media-inset": "12px",
      "--qm-modal-photo-ratio": "4 / 3",
      "--qm-modal-photo-border": "1px solid var(--qm-ink)",
      "--qm-modal-photo-cap": "3px solid var(--qm-primary)",
      "--qm-modal-lead-bg": "transparent",
      "--qm-modal-lead-border": "1px solid var(--qm-ink)",
      ...
      "--qm-modal-handle-radius": "0px",
      "--qm-modal-close-bg": "transparent",
      "--qm-modal-close-border": "2px solid var(--qm-primary)",
      "--qm-modal-close-color": "var(--qm-ink)",
      "--qm-modal-close-radius": "2px",
